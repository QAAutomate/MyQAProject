...
public class DataProviderMain {
	...
	public static String[][] dataProvide(Method m) throws IOException{
		...
		String path ="C:/Users/hamsi/TrainingWorkspace/XeroSeleniumExam/src/test/java/utility/Data.xls";
	...
	public static String[][] getData(Method m) throws IOException{
		...
		String path ="C:/Users/hamsi/TrainingWorkspace/XeroSeleniumExam/src/test/java/utility/OrgData.xls";
