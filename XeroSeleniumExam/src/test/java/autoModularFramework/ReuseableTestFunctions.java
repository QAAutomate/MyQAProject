...
public class ReuseableTestFunctions {
	...
	public static WebDriver launchBrowser(String browserName) {
		...
		if(browserName.equalsIgnoreCase("firefoxBrowser")) {
			String driverpath ="C:/Users/hamsi/TrainingWorkspace/SeleniumMaven/src/test/java/utility/geckodriver.exe";
			System.setProperty("webdriver.gecko.driver", driverpath);
			driver= new FirefoxDriver();
		}
		else if(browserName.equalsIgnoreCase("chromeBrowser")) {
			String driverpath ="C:/Users/hamsi/TrainingWorkspace/SeleniumMaven/src/test/java/utility/chromedriver.exe";
