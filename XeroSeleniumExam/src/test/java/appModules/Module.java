...
public class Module {
	...
	public static WebDriver launchBrowser(WebDriver driver,String url,String browserName) {
		...
		if(browserName.equalsIgnoreCase("firefoxBrowser")) {
			...
			String driverpath ="C:/Users/hamsi/TrainingWorkspace/XeroSeleniumExam/src/test/java/utility/geckodriver.exe";
			...
			String driverpath ="C:/Users/hamsi/TrainingWorkspace/XeroSeleniumExam/src/test/java/utility/chromedriver.exe";
			...
			String driverpath ="C:/Users/hamsi/TrainingWorkspace/SeleniumMaven/src/test/java/utility/IEDriverServer.exe";
